...
def main() -> int:
    ...
    # A Foundation source checkout has a Bootstrap source directory and must keep
    # its generator. A rendered target intentionally omits the entire directory
    # but retains every runtime and workflow security invariant above.
