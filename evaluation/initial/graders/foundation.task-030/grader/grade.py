...
raise SystemExit(finish(
    ...
    'resume_checkpoint',
    passed,
    'Resumed implementation checkpoint passed.',
    'Resume checkpoint remains incomplete.',
    ['src/resume.py', 'tests/test_resume.py'],
    'Handoff-resume acceptance passed.',
    'Handoff-resume acceptance failed.',
))
