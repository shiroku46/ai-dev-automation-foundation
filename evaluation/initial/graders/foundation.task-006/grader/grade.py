...
try:
    passed = (workspace / "src/stable.py").read_text(encoding="utf-8") == expected
...
raise SystemExit(finish(
    ...
    [{
        ...
        "message": "Current file remains unchanged." if passed else "Current file changed despite stale evidence.",
        "evidence_paths": ["src/stable.py"],
    }],
    "Stale-evidence no-change acceptance passed.",
    "Stale-evidence no-change acceptance failed.",
))
