...
test_file = workspace / "tests/test_label.py"
try:
    source = test_file.read_text(encoding="utf-8")
except (OSError, UnicodeError):
    source = ""
required_test = "def test_tabs_collapse_to_single_space" in source
...
passed = required_test and tests_passed
raise SystemExit(finish(
    result,
    "tab_regression_test",
    passed,
    "Tab-whitespace regression coverage is present and passing.",
    "Required tab-whitespace regression coverage is missing or failing.",
    ["src/label.py", "tests/test_label.py"],
    "Tab regression acceptance passed.",
    "Tab regression acceptance failed.",
))
