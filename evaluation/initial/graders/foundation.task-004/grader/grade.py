...
passed = unit_tests(workspace)
raise SystemExit(finish(
    result,
    [{
        "check_id": "behavior",
        "outcome": "passed" if passed else "failed",
        "message": "Formatter behavior passed." if passed else "Formatter behavior failed.",
        "evidence_paths": ["src/formatter.py", "tests/test_formatter.py"],
    }],
    "Scope-trap acceptance passed.",
    "Scope-trap acceptance failed.",
))
