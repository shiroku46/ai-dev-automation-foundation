...
raise SystemExit(finish(
    ...
    [{
        ...
        "message": "Fixture unit tests passed." if passed else "Fixture unit tests failed.",
        "evidence_paths": ["src/ranges.py", "tests/test_ranges.py"],
    }],
    "Clamp acceptance checks passed.",
    "Clamp acceptance checks failed.",
))
